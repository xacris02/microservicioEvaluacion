...
4. Se nos permite usar ramas hotfix/ para aplicar parches urgentes directamente a main si el microservicio fall, sin tener que arrastrar código incompleto.